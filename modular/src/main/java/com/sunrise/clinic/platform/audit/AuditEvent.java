...
public class AuditEvent {
    ...
    /*
     * The actor's role as text, not as the Role enum.
     *
     * platform/ must depend on no feature module, and Role belongs to access.
     * Denormalising is also right on its own terms: an audit record is a
     * snapshot of what happened, so it must survive the enum being renamed or
     * a value being retired. The database column stays an ENUM; this side
     * stores its name.
     */
    ...
    public AuditEvent(String id, String actorUid, String actorRole, String action, String targetType, String targetId, Instant timestamp) {
        this.id = id;
