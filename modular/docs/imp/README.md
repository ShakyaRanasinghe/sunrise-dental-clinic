...
| | |
|---|---|
| **Active step** | **6 — `notifications`** |
| Steps complete | **5 of 9** — through `billing`. **All six of the brief's functions work** |
...
| `modular/` | 122 Java files, 23 views, **184 tests green**, deploys and answers |
